...
(function() {
  var $$, Action, DEBUG, Namespace, action, adir, assert, getattr, hasattr, namespace, parser, path, setattr, util, _, _AppendAction, _AppendConstAction, _CountAction, _HelpAction, _StoreAction, _StoreConstAction, _StoreFalseAction, _StoreTrueAction, _SubParsersAction, _VersionAction, _ensure_value,
    __slice = [].slice,
  ...
  Action = (function() {
    ...
    */
    ...
    function Action(options) {
      ...
      this.optionStrings = (_ref = (_ref1 = options.option_strings) != null ? _ref1 : options.optionStrings) != null ? _ref : [];
      this.dest = (_ref2 = options.dest) != null ? _ref2 : '';
      this.nargs = (_ref3 = options.nargs) != null ? _ref3 : null;
      this.constant = (_ref4 = options.constant) != null ? _ref4 : null;
      this.defaultValue = (_ref5 = options.defaultValue) != null ? _ref5 : null;
      this.type = (_ref6 = options.type) != null ? _ref6 : null;
      this.choices = (_ref7 = options.choices) != null ? _ref7 : null;
      this.required = (_ref8 = options.required) != null ? _ref8 : false;
      this.help = (_ref9 = options.help) != null ? _ref9 : null;
      this.metavar = (_ref10 = options.metavar) != null ? _ref10 : null;
    }
  ...
  _HelpAction = (function(_super) {
    ...
    _HelpAction.prototype.__call__ = function(parser, namespace, values, option_string) {
      ...
      parser.print_help();
      if (parser.debug) {
        return console.log('Help pseudo exit');
      } else {
        return parser.exit();
      }
    };
  ...
  _SubParsersAction = (function(_super) {
    ...
    _SubParsersAction.prototype.add_parser = function(name, options) {
      var alias, aliases, choice_action, help, parser, _i, _len, _ref;
      if (options == null) {
        options = {};
      }
