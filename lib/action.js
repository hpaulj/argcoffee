...
(function() {
  ...
  Action = (function() {
    ...
    */
    ...
    function Action(options) {
      ...
      this.optionStrings = (_ref = options.option_strings) != null ? _ref : options.optionStrings;
      this.dest = options.dest;
      this.nargs = (_ref1 = options.nargs) != null ? _ref1 : null;
      this.constant = (_ref2 = options.constant) != null ? _ref2 : null;
      this.defaultValue = (_ref3 = options.defaultValue) != null ? _ref3 : null;
      this.type = (_ref4 = options.type) != null ? _ref4 : null;
      this.choices = (_ref5 = options.choices) != null ? _ref5 : null;
      this.required = (_ref6 = options.required) != null ? _ref6 : false;
      this.help = (_ref7 = options.help) != null ? _ref7 : null;
      this.metavar = (_ref8 = options.metavar) != null ? _ref8 : null;
    }
  ...
  _HelpAction = (function(_super) {
    ...
    function _HelpAction(options) {
      ...
      DEBUG(this.__call__);
      DEBUG(this.isPositional);
      DEBUG(this.optionStrings);
      DEBUG(this.getName());
    }
  ...
  _SubParsersAction = (function(_super) {
    ...
    */
    ...
    function _SubParsersAction(options) {
      ...
      options.dest = (_ref = options.dest) != null ? _ref : $$.SUPPRESS;
    ...
    _SubParsersAction.prototype.add_parser = function(name, options) {
      var choice_action, help, parser, _ref;
      ...
      parser = this._parser_class(options);
    ...
    _SubParsersAction.prototype.__call__ = function(parser, namespace, values, option_string) {
      var arg_strings, choices, msg, parser_name, _ref, _ref1;
      if (option_string == null) {
        option_string = null;
      }
