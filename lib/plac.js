...
(function() {
  var Annotation, ArgumentParser, DEBUG, PARSER_CFG, afunc, annotations, argparse, assert, call, d, formal_parameter_list, getargspec, getfullargspec, is_annotation, iterable, main, p4, parser, parser_from, parser_from1, path, pconf, source, sources, util, _, _extract_kwargs, _i, _len, _match_cmd, _parser_registry,
    __slice = [].slice,
