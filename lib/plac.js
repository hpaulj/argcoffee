...
var Annotation, ArgumentParser, DEBUG, GetFullArgspec, PARSER_CFG, afunc, annotations, argparse, assert, call, d, getargspec, is_annotation, iterable, main, p4, parse_function, parser, parser_from, parser_from1, path, pconf, source, sources, util, _, _extract_kwargs, _i, _len, _match_cmd, _parser_registry,
  __slice = [].slice,
...
ArgumentParser = (function(_super) {
  ...
  ArgumentParser.prototype.populate_from = function(func) {
    var a, alldefaults, ann, defaultValue, defaults, dflt, f, i, metavar, n_args, n_defaults, name, nargs, prefix, shortlong, _j, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
    ...
    alldefaults = ((function() {
      ...
      _results = [];
      for (i = _j = 0, _ref1 = n_args - n_defaults; 0 <= _ref1 ? _j < _ref1 : _j > _ref1; i = 0 <= _ref1 ? ++_j : --_j) {
        _results.push(null);
      }
      return _results;
    })()).concat(defaults);
