...
var Annotation, ArgumentParser, DEBUG, GetFullArgspec, PARSER_CFG, afunc, annotations, argparse, assert, call, d, formal_parameter_list, getargspec, is_annotation, iterable, main, p4, parser, parser_from, parser_from1, path, pconf, source, sources, util, _, _extract_kwargs, _i, _len, _match_cmd, _parser_registry,
  __slice = [].slice,
...
formal_parameter_list = function(fn) {
  var FN_ARG, FN_ARGS, FN_ARG_SPLIT, STRIP_COMMENTS, a, arg, arg_decl, args, cmts, doc, fn_text, name, r, repfn;
