...
(function() {
  var Annotation, ArgumentParser, DEBUG, PARSER_CFG, alt_getarglist, annotation_from, annotations, argparse, assert, call, d, formal_parameter_list, getargspec, getfullargspec, is_annotation, iterable, main, parser, parser_from, path, pconf, util, _, _extract_kwargs, _match_cmd, _parser_registry,
    __slice = [].slice,
...
function formalParameterList(fn) {
  ...
  formal_parameter_list = function(fn) {
    var FN_ARG, FN_ARGS, FN_ARG_SPLIT, STRIP_COMMENTS, a, arg, arg_decl, args, fn_text, r;
  ...
  getfullargspec = (function() {
    ...
    function getfullargspec(f) {
      ...
      this.defaults = [];
      this.annotations = (_ref = f.__annotations__) != null ? _ref : {};
    }
  ...
  */
  ...
  pconf = function(obj) {
    ...
    for (name in obj) {
      if (__indexOf.call(PARSER_CFG, name) >= 0) {
        cfg[name] = obj[name];
      }
    }
    return cfg;
  ...
  parser_from = function(obj, confparams) {
    ...
    if ((obj['commands'] != null) && !_.isClass(obj)) {
  ...
  ArgumentParser = (function(_super) {
    ...
    function ArgumentParser() {
      return ArgumentParser.__super__.constructor.apply(this, arguments);
    }
    ...
    ArgumentParser.prototype.consume = function(args) {
      ...
      if (this.subparsers != null) {
        _ref = this._extract_subparser_cmd(arglist), subp = _ref[0], cmd = _ref[1];
    ...
    ArgumentParser.prototype._extract_subparse_cmd = function(arglist) {
      var arg, cmd, i, name_parser_map, optprefix, _i, _j, _len, _ref, _ref1, _ref2, _results;
      optprefix = this.prefix_chars[0];
      name_parser_map = this.subparsesrs._name_parser_map;
    ...
    ArgumentParser.prototype.addsubcommands = function(commands, obj, title, cmdprefix) {
      ...
      if (!(this.subparsers != null)) {
        this.subparsers = this.add_subparsers({
          title: title
        });
      } else if (title != null) {
        this.add_argument_group({
          title: title
        });
      }
    ...
    ArgumentParser.prototype.missing = function(name) {
      ...
      miss = (_ref = this.obj['__missing__']) != null ? _ref : function(name) {
        return this.error("No command " + name);
      };
      return miss(name);
    };
