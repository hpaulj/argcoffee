...
(function() {
  var Annotation, ArgumentParser, DEBUG, GetFullArgspec, PARSER_CFG, afunc, annotations, argparse, assert, call, d, getargspec, is_annotation, iterable, main, p4, parse_function, parser, parser_from, parser_from1, pconf, source, sources, _, _extract_kwargs, _i, _len, _match_cmd, _parser_registry,
    __slice = [].slice,
