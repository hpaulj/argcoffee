...
(function() {
  var Annotation, ArgumentParser, DEBUG, PARSER_CFG, afunc, alt_getarglist, annotation_from, annotations, argparse, assert, call, d, formal_parameter_list, getargspec, getfullargspec, is_annotation, iterable, main, p4, parser, parser_from, parser_from1, path, pconf, util, _, _extract_kwargs, _match_cmd, _parser_registry,
    __slice = [].slice,
