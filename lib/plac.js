...
(function() {
  var Annotation, ArgumentParser, DEBUG, PARSER_CFG, afunc, alt_getarglist, annotation_from, annotations, argparse, assert, call, d, foo, formal_parameter_list, getargspec, getfullargspec, is_annotation, iterable, main, parser, parser_from, path, pconf, util, _, _extract_kwargs, _match_cmd, _parser_registry,
    __slice = [].slice,
...
function formalParameterList(fn) {
  ...
  getfullargspec = (function() {
    ...
    function getfullargspec(f) {
      var _ref, _ref1;
      this.args = formal_parameter_list(f);
      ...
      this.defaults = (_ref = f.defaults) != null ? _ref : [];
      this.annotations = (_ref1 = f.__annotations__) != null ? _ref1 : {};
    }
  ...
  */
  ...
  ArgumentParser = (function(_super) {
    ...
    function ArgumentParser() {
      ArgumentParser.__super__.constructor.call(this);
      this.test = 'testing';
    }
