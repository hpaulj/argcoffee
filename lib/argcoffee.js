...
(function() {
  var $$, ActionContainer, ArgumentParser, DEBUG, FileClass, FileType, HelpFormatter, Namespace, Nsp, TEST, action, adir, args, argumentErrorHelper, argv, assert, c1, c2, childParser, getattr, hasattr, int1, np, parentParser, parser, path, setattr, subparsers, util, _, _ActionsContainer, _ensure_value, _get_action_name,
    __slice = [].slice,
  ...
  ArgumentParser = (function(_super) {
    ...
    function ArgumentParser(options) {
      var acoptions, defaultKey, default_prefix, parent, _i, _len, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if (options == null) {
        options = {};
      }
      ...
      for (_i = 0, _len = _ref12.length; _i < _len; _i++) {
        parent = _ref12[_i];
        ((_ref13 = this._addContainerActions) != null ? _ref13 : this._add_container_actions)(parent);
    ...
    ArgumentParser.prototype._parse_known_args = function(arg_strings, namespace) {
      var action, actionConflicts, actionHash, action_used, arg_string, arg_string_pattern, arg_string_pattern_parts, conflicts, consume_optional, consume_positionals, extras, group, group_actions, i, index, index_keys, key, max_option_string_index, msg, mutex_action, mutex_group, mxgroups, names, next_option_string_index, option_string_indices, option_tuple, pattern, positionals, positionals_end_index, seen_actions, seen_non_default_actions, start_index, stop_index, strings, take_action, x, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
        _this = this;
      ...
      consume_optional = function(start_index) {
        var action, action_tuples, arg_count, args, char, chars, explicit_arg, match_argument, msg, new_explicit_arg, option_string, optionals_map, selected_patterns, start, stop, _len4, _m, _ref2, _ref3, _ref4;
        ...
        while (true) {
          ...
          if (explicit_arg != null) {
            ...
            if (arg_count === 0 && (_ref2 = option_string[1], __indexOf.call(chars, _ref2) < 0)) {
              ...
              optionals_map = (_ref3 = _this._optionStringActions) != null ? _ref3 : _this._option_string_actions;
        ...
        for (_m = 0, _len4 = action_tuples.length; _m < _len4; _m++) {
          _ref4 = action_tuples[_m], action = _ref4[0], args = _ref4[1], option_string = _ref4[2];
      ...
      action_used = false;
      _ref4 = (_ref3 = this._mutuallyExclusiveGroups) != null ? _ref3 : this._mutually_exclusive_groups;
      for (_n = 0, _len5 = _ref4.length; _n < _len5; _n++) {
        ...
        if (group.required) {
          ...
          if (!action_used) {
            ...
            names = (function() {
              var _len7, _p, _ref6, _results;
              _ref6 = group._groupActions;
              _results = [];
    ...
    ArgumentParser.prototype._parse_optional = function(arg_string) {
      ...
      if (__indexOf.call(arg_string, '=') >= 0) {
        ...
        if (aActions[option_string] != null) {
    ...
    */
    ...
    ArgumentParser.prototype.format_help = function() {
      var actionGroup, formatter, _i, _len, _ref, _ref1;
      formatter = this._getFormatter();
      formatter.addUsage(this.usage, this._actions, []);
