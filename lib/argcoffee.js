...
(function() {
  var $$, ArgumentParser, DEBUG, FileClass, FileType, HelpFormatter, Namespace, Nsp, TEST, action, adir, args, argv, assert, c1, c2, childParser, getattr, hasattr, int1, np, parentParser, parser, path, setattr, subparsers, testparse, util, _, _ActionsContainer, _ensure_value, _get_action_name,
    __slice = [].slice,
  ...
  */
  ...
  FileClass = (function() {
    ...
    */
    ...
    FileClass.prototype.testread = function(filename) {
      var stats;
    ...
    FileClass.prototype.testwrite = function(filename) {
      var fd, preexisting;
    ...
    FileClass.prototype.call1 = function(filename) {
      var flags, msg, openfn, stream;
      flags = this.options.flags;
      console.log(this.options, flags);
      if (filename === '-') {
      ...
      stream = openfn(filename, this.options);
      return stream;
    };
