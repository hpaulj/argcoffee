...
(function() {
  var $$, ActionContainer, ArgumentParser, DEBUG, FileClass, FileType, HelpFormatter, Namespace, TEST, action, adir, argumentErrorHelper, argv, assert, childParser, getattr, hasattr, int1, np, parentParser, parser, path, setattr, util, _, _ActionsContainer, _ensure_value, _get_action_name,
    __slice = [].slice,
  ...
  ArgumentParser = (function(_super) {
    ...
    ArgumentParser.prototype.add_subparsers = function(options) {
      ...
      if (this._subparsers._addAction != null) {
