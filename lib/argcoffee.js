...
(function() {
  var $$, ArgumentParser, DEBUG, FileClass, FileType, HelpFormatter, Namespace, Nsp, TEST, action, adir, args, argv, assert, c1, c2, childParser, fileType, getattr, hasattr, int1, np, parentParser, parser, path, setattr, subparsers, testparse, util, _, _ActionsContainer, _ensure_value, _get_action_name,
    __slice = [].slice,
  ...
  */
  ...
  fileType = function(options) {
    var createStream, flags, fn, fs, std, _ref, _ref1;
    if (options == null) {
      options = {
        flags: 'r'
      };
