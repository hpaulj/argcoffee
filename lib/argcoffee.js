...
(function() {
  var $$, ArgumentError, ArgumentParser, ArgumentTypeError, DEBUG, FileClass, FileType, HelpFormatter, Namespace, Nsp, TEST, action, args, argv, assert, c1, c2, childParser, fileType, getattr, hasattr, int1, np, parentParser, parser, path, setattr, subparsers, testparse, util, _, _ActionsContainer, _ensure_value, _ref,
    __slice = [].slice,
  ...
  _ref = require('./error'), ArgumentError = _ref.ArgumentError, ArgumentTypeError = _ref.ArgumentTypeError;
  ...
  Namespace = (function() {
    ...
    Namespace.prototype.get = function(key, defaultValue) {
      var _ref1;
      return (_ref1 = this[key]) != null ? _ref1 : defaultValue;
    };
  ...
  ArgumentParser = (function(_super) {
    ...
    function ArgumentParser(options) {
      var acoptions, defaultKey, default_prefix, parent, _i, _len, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if (options == null) {
        options = {};
      }
      ...
      this.prog = (_ref1 = options.prog) != null ? _ref1 : path.basename(process.argv[1]);
      this.usage = (_ref2 = options.usage) != null ? _ref2 : null;
      this.epilog = (_ref3 = options.epilog) != null ? _ref3 : null;
      this.parents = (_ref4 = options.parents) != null ? _ref4 : [];
      this.formatter_class = (_ref5 = options.formatter_class) != null ? _ref5 : HelpFormatter;
      this.fromfile_prefix_chars = (_ref6 = options.fromfile_prefix_chars) != null ? _ref6 : null;
      this.add_help = (_ref7 = (_ref8 = options.addHelp) != null ? _ref8 : options.add_help) != null ? _ref7 : true;
      this.debug = (_ref9 = options.debug) != null ? _ref9 : false;
      this.description = (_ref10 = options.description) != null ? _ref10 : null;
      this.prefix_chars = (_ref11 = (_ref12 = options.prefixChars) != null ? _ref12 : options.prefix_chars) != null ? _ref11 : '-';
      this.argument_default = (_ref13 = (_ref14 = options.argumentDefault) != null ? _ref14 : options.argument_default) != null ? _ref13 : null;
      this.conflict_handler = (_ref15 = (_ref16 = options.conflict_handler) != null ? _ref16 : options.conflictHandler) != null ? _ref15 : 'error';
      acoptions = {
    ...
    ArgumentParser.prototype.add_subparsers = function(options) {
      var ParsersClass, action, description, formatter, groups, positionals, title, _ref1, _ref2, _ref3;
      if (options == null) {
        options = {};
      }
      ...
      if ((options.title != null) || (options.description != null)) {
        title = (_ref1 = options.title) != null ? _ref1 : 'subcommands';
        description = (_ref2 = options.description) != null ? _ref2 : null;
      ...
      if (!(options.prog != null)) {
        ...
        groups = (_ref3 = this._mutuallyExclusiveGroups) != null ? _ref3 : this._mutually_exclusive_groups;
    ...
    ArgumentParser.prototype._get_positional_actions = function() {
      ...
      return (function() {
        ...
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          action = _ref1[_i];
          if ((action != null) && !action.isOptional()) {
            _results.push(action);
          }
        }
        return _results;
    ...
    ArgumentParser.prototype.parse_args = function(args, namespace) {
      ...
      _ref1 = this.parse_known_args(args, namespace), args = _ref1[0], argv = _ref1[1];
      if (argv.length > 0) {
    ...
    ArgumentParser.prototype.parse_known_args = function(args, namespace) {
      var action, argv, dest, _default, _i, _len, _ref1, _ref2;
      if (args == null) {
        args = null;
      }
      if (namespace == null) {
      ...
      try {
        ...
        _ref2 = this._parse_known_args(args, namespace), namespace = _ref2[0], args = _ref2[1];
    ...
    ArgumentParser.prototype._parse_known_args = function(arg_strings, namespace) {
      ...
      mxgroups = (_ref1 = this._mutuallyExclusiveGroups) != null ? _ref1 : this._mutually_exclusive_groups;
      for (_i = 0, _len = mxgroups.length; _i < _len; _i++) {
        mutex_group = mxgroups[_i];
        group_actions = (_ref2 = mutex_group._groupActions) != null ? _ref2 : mutex_group._group_actions;
      ...
      take_action = function(action, argument_strings, option_string) {
        var actionConflict, argument_values, msg, _len4, _m, _ref4;
        ...
        if (argument_values !== action.defaultValue) {
          ...
          if (actionConflicts[key] != null) {
            _ref4 = actionConflicts[key];
            for (_m = 0, _len4 = _ref4.length; _m < _len4; _m++) {
              actionConflict = _ref4[_m];
      ...
      consume_optional = function(start_index) {
        var action, action_tuples, arg_count, args, char, chars, explicit_arg, match_argument, msg, new_explicit_arg, option_string, optionals_map, selected_patterns, start, stop, tuple, _len4, _m, _ref4;
        ...
        while (true) {
          ...
          if (explicit_arg != null) {
            ...
            if (arg_count === 0 && (_ref4 = option_string[1], __indexOf.call(chars, _ref4) < 0)) {
      ...
      consume_positionals = function(start_index) {
        var action, arg_count, arg_counts, args, match_partial, selected_pattern, _len4, _m, _ref4, _ref5, _ref6;
        ...
        _ref4 = _.zipShortest(positionals, arg_counts);
        for (_m = 0, _len4 = _ref4.length; _m < _len4; _m++) {
          _ref5 = _ref4[_m], action = _ref5[0], arg_count = _ref5[1];
        ...
        [].splice.apply(positionals, [0, 9e9].concat(_ref6 = positionals.slice(arg_counts.length))), _ref6;
        return start_index;
      };
      extras = [];
      start_index = 0;
      index_keys = (function() {
        ...
        _ref4 = _.keys(option_string_indices);
        _results = [];
        for (_m = 0, _len4 = _ref4.length; _m < _len4; _m++) {
          x = _ref4[_m];
          _results.push(+x);
      ...
      action_used = false;
      _ref6 = (_ref5 = this._mutuallyExclusiveGroups) != null ? _ref5 : this._mutually_exclusive_groups;
      for (_n = 0, _len5 = _ref6.length; _n < _len5; _n++) {
        group = _ref6[_n];
        if (group.required) {
          DEBUG('group required');
          gactions = (_ref7 = group._groupActions) != null ? _ref7 : group._group_actions;
    ...
    ArgumentParser.prototype._read_args_from_files = function(arg_strings) {
      var arg, arg_line, arg_string, argstrs, content, filename, fs, new_arg_strings, _i, _j, _k, _len, _len1, _len2, _ref1, _ref2;
      fs = require('fs');
      new_arg_strings = [];
      for (_i = 0, _len = arg_strings.length; _i < _len; _i++) {
        arg_string = arg_strings[_i];
        if (_ref1 = arg_string[0], __indexOf.call(this.fromfile_prefix_chars, _ref1) < 0) {
          ...
          try {
            ...
            for (_j = 0, _len1 = content.length; _j < _len1; _j++) {
              arg_line = content[_j];
              _ref2 = this.convert_arg_line_to_args(arg_line);
    ...
    ArgumentParser.prototype._match_argument = function(action, arg_strings_pattern) {
      var args_errors, matches, msg, nargs_pattern, _ref1;
      ...
      if (!(matches != null)) {
        ...
        msg = (_ref1 = args_errors[action.nargs]) != null ? _ref1 : "expected " + action.nargs + " argument(s)";
        throw new ArgumentError(action, msg);
      }
    ...
    ArgumentParser.prototype._match_arguments_partial = function(actions, arg_strings_pattern) {
      var a, action, actions_slice, foo, i, m, pattern, result, string, _i, _ref1;
      result = [];
      ...
      for (i = _i = _ref1 = actions.length; _ref1 <= 0 ? _i <= 0 : _i >= 0; i = _ref1 <= 0 ? ++_i : --_i) {
    ...
    ArgumentParser.prototype._parse_optional = function(arg_string) {
      var action, actions, explicit_arg, option_string, option_tuple, option_tuples, options, tup, _ref1, _ref2;
      assert(this.prefix_chars != null);
      DEBUG('parse opt:', arg_string, this.prefix_chars);
      if (!arg_string) {
        return null;
      }
      if (!(_ref1 = arg_string[0], __indexOf.call(this.prefix_chars, _ref1) >= 0)) {
        return null;
      }
    ...
    ArgumentParser.prototype._get_option_tuples = function(option_string) {
      var action, actions, chars, explicit_arg, option_prefix, result, short_explicit_arg, short_option_prefix, tup, _ref1, _ref2, _ref3, _ref4, _ref5;
      result = [];
      chars = this.prefix_chars;
      if ((_ref1 = option_string[0], __indexOf.call(chars, _ref1) >= 0) && (_ref2 = option_string[1], __indexOf.call(chars, _ref2) >= 0)) {
        if (__indexOf.call(option_string, '=') >= 0) {
          _ref3 = option_string.split('='), option_prefix = _ref3[0], explicit_arg = _ref3[1];
        } else {
    ...
    ArgumentParser.prototype._get_values = function(action, arg_strings) {
      var arg_string, s, v, value, _i, _len, _ref1, _ref2;
      DEBUG('_get_values:');
      ...
      if (arg_strings.length === 0 && action.nargs === $$.OPTIONAL) {
        ...
        this._check_value(action, value);
      } else if (arg_strings.length === 1 && ((_ref2 = action.nargs) === null || _ref2 === $$.OPTIONAL)) {
    ...
    */
    ...
    ArgumentParser.prototype.format_help = function() {
      var actionGroup, formatter, _i, _len, _ref1, _ref2, _ref3;
      formatter = this._getFormatter();
      formatter.addUsage(this.usage, this._actions, this._mutually_exclusive_groups);
      formatter.addText(this.description);
      _ref2 = (_ref1 = this._actionGroups) != null ? _ref1 : this._action_groups;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        actionGroup = _ref2[_i];
        formatter.startSection(actionGroup.title);
        formatter.addText(actionGroup.description);
        formatter.addArguments((_ref3 = actionGroup._groupActions) != null ? _ref3 : actionGroup._group_actions);
  ...
  */
  ...
  getattr = function(obj, key, defaultValue) {
    var _ref1;
    return (_ref1 = obj[key]) != null ? _ref1 : defaultValue;
  };
  ...
  fileType = function(options) {
    var createStream, flags, fn, fs, msg, std, _ref1, _ref2;
    if (options == null) {
      options = {
        flags: 'r'
      };
    ...
    if (flags === 'r') {
      _ref1 = [process.stdin, fs.createReadStream], std = _ref1[0], createStream = _ref1[1];
    } else if (flags === 'w') {
      _ref2 = [process.stdout, fs.createWriteStream], std = _ref2[0], createStream = _ref2[1];
    } else {
  ...
  if (TEST && 0) {
    ...
    if (0) {
      ...
      console.log('child optional actions:\n', util.inspect((function() {
        var _i, _len, _ref1, _results;
        _ref1 = childParser._optionals._groupActions;
        _results = [];
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          action = _ref1[_i];
      ...
      console.log('child positional actions:\n', util.inspect((function() {
        var _i, _len, _ref1, _results;
        _ref1 = childParser._positionals._groupActions;
        _results = [];
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          action = _ref1[_i];
          _results.push(action.dest);
