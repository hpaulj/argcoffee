...
(function() {
  var $$, ArgumentError, ArgumentParser, ArgumentTypeError, DEBUG, FileClass, FileType, HelpFormatter, Namespace, Nsp, TEST, a, action, args, argv, assert, c1, c2, childParser, fileType, getattr, hasattr, int1, np, p, parentParser, parser, path, setattr, subparsers, testparse, util, _, _ActionsContainer, _ensure_value, _ref,
    __slice = [].slice,
    _this = this,
  ...
  ArgumentParser = (function(_super) {
    ...
    function ArgumentParser(options) {
      var acoptions, defaultKey, default_prefix, parent, _i, _len, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
        _this = this;
      if (options == null) {
        options = {};
      }
      ...
      this.formatter_class = (_ref5 = (_ref6 = options.formatter_class) != null ? _ref6 : options.formatterClass) != null ? _ref5 : HelpFormatter;
      this.fromfile_prefix_chars = (_ref7 = options.fromfile_prefix_chars) != null ? _ref7 : null;
    ...
    ArgumentParser.prototype._parse_known_args = function(arg_strings, namespace) {
      var action, actionConflicts, actionHash, action_used, arg_string, arg_string_pattern, arg_string_pattern_parts, conflicts, consume_optional, consume_positionals, extras, foo, gactions, group, group_actions, i, index_keys, key, max_option_string_index, msg, mutex_action, mutex_group, mxgroups, names, next_option_string_index, option_string_indices, option_tuple, pattern, positionals, positionals_end_index, seen_actions, seen_non_default_actions, start_index, stop_index, strings, take_action, x, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7,
        _this = this;
      ...
      consume_optional = function(start_index) {
        var action, action_tuples, arg_count, args, chars, explicit_arg, match_argument, msg, new_explicit_arg, option_string, optionals_map, selected_patterns, start, stop, tuple, _len4, _m, _ref4;
    ...
    ArgumentParser.prototype._read_args_from_files = function(arg_strings) {
      var arg, arg_line, arg_string, argstrs, content, filename, firstchar, fs, new_arg_strings, _i, _j, _k, _len, _len1, _len2, _ref1;
      fs = require('fs');
      new_arg_strings = [];
    ...
    ArgumentParser.prototype._match_arguments_partial = function(actions, arg_strings_pattern) {
      var a, actions_slice, foo, i, m, pattern, result, strlength, _i, _ref1;
      result = [];
