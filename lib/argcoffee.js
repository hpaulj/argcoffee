...
(function() {
  var $$, ArgumentParser, DEBUG, FileClass, FileType, HelpFormatter, Namespace, Nsp, TEST, action, adir, args, argumentError, argv, assert, c1, c2, childParser, getattr, hasattr, int1, np, parentParser, parser, path, setattr, subparsers, testparse, util, _, _ActionsContainer, _ensure_value, _get_action_name,
    __slice = [].slice,
