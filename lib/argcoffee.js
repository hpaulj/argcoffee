...
var $$, ActionContainer, ArgumentParser, DEBUG, FileClass, FileType, HelpFormatter, Namespace, TEST, action, adir, args, argumentaErrorHelper, argv, assert, childParser, getattr, hasattr, int1, parentParser, parser, path, setattr, util, _, _ActionsContainer, _ensure_value, _get_action_name,
...
ArgumentParser = (function(_super) {
  ...
  function ArgumentParser(options) {
    var acoptions, defaultKey, default_prefix, parent, _i, _len, _ref, _ref1, _ref10, _ref11, _ref12, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    if (options == null) {
      options = {};
    }
    ...
    this.add_help = (_ref6 = options.add_help) != null ? _ref6 : true;
    this.debug = (_ref7 = options.debug) != null ? _ref7 : false;
    this.description = (_ref8 = options.description) != null ? _ref8 : null;
    this.prefix_chars = (_ref9 = options.prefix_chars) != null ? _ref9 : '-';
    this.argument_default = (_ref10 = options.argument_default) != null ? _ref10 : null;
    this.conflict_handler = (_ref11 = options.conflict_handler) != null ? _ref11 : 'error';
    acoptions = {
      description: this.description,
      prefixChars: this.prefix_chars,
      argumentDefault: this.argument_default,
  ...
  ArgumentParser.prototype.add_subparsers = function(options) {
    var ParsersClass, action, description, formatter, groups, positionals, title, _ref, _ref1;
    if (options == null) {
      options = {};
    }
  ...
  ArgumentParser.prototype.parse_known_args = function(args, namespace) {
    var action, argv, dest, _default, _i, _len, _ref, _ref1, _ref2;
    if (args == null) {
      args = null;
    }
    if (namespace == null) {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      action = _ref[_i];
      if (_ref1 = action.dest, __indexOf.call(!$$.SUPPRESS, _ref1) >= 0) {
  ...
  ArgumentParser.prototype._parse_known_args = function(arg_strings, namespace) {
    var action, action_conflicts, arg_string, arg_string_pattern, arg_string_pattern_parts, consume_optional, consume_positionals, extras, i, index, index_keys, max_option_string_index, name, next_option_string_index, option_string_indices, option_tuple, pattern, positionals, positionals_end_index, seen_actions, seen_non_default_actions, start_index, stop_index, strings, take_action, x, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2,
      _this = this;
    ...
    */
    ...
    for (i = _i = 0, _len = arg_strings.length; _i < _len; i = ++_i) {
      arg_string = arg_strings[i];
      if (arg_string === '--') {
        arg_string_pattern_parts.push('-');
        _ref = arg_strings.slice(i + 1);
    ...
    take_action = function(action, argument_strings, option_string) {
      ...
      if (argument_values !== $$.SUPPRESS) {
        ...
        return DEBUG('takenaction:', action.dest, namespace, argument_values, option_string);
      }
    };
    consume_optional = function(start_index) {
      var action, action_tuples, arg_count, args, char, chars, explicit_arg, match_argument, msg, new_explicit_arg, option_string, optionals_map, selected_patterns, start, stop, _k, _len2, _ref1, _ref2, _ref3;
      ...
      while (true) {
        ...
        if (explicit_arg === !null) {
          ...
          if (arg_count === 0 && (_ref1 = option_string[1], __indexOf.call(chars, _ref1) < 0)) {
            action_tuples.push([action, [], option_string]);
            char = option_string[0];
            option_string = char + explicit_arg[0];
            new_explicit_arg = (_ref2 = explicit_arg.slice(1)) != null ? _ref2 : null;
      ...
      for (_k = 0, _len2 = action_tuples.length; _k < _len2; _k++) {
        _ref3 = action_tuples[_k], action = _ref3[0], args = _ref3[1], option_string = _ref3[2];
    ...
    consume_positionals = function(start_index) {
      var a, action, arg_count, arg_counts, args, match_partial, selected_pattern, _k, _len2, _ref1, _ref2, _ref3;
      ...
      _ref1 = _.zip(positionals, arg_counts);
      for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
        _ref2 = _ref1[_k], action = _ref2[0], arg_count = _ref2[1];
      ...
      [].splice.apply(positionals, [0, 9e9].concat(_ref3 = positionals.slice(arg_counts.length))), _ref3;
    ...
    index_keys = (function() {
      ...
      _ref1 = _.keys(option_string_indices);
      _results = [];
      for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
        x = _ref1[_k];
        _results.push(+x);
    ...
    while (start_index <= max_option_string_index) {
      next_option_string_index = Math.min.apply(Math, (function() {
        var _k, _len2, _results;
        _results = [];
        for (_k = 0, _len2 = index_keys.length; _k < _len2; _k++) {
          index = index_keys[_k];
    ...
    for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
      action = _ref1[_k];
      if (action.required) {
        if (_ref2 = action.dest, __indexOf.call(_.keys(seen_actions), _ref2) < 0) {
  ...
  ArgumentParser.prototype._parse_optional = function(arg_string) {
    var action, explicit_arg, option_string, option_tuple, option_tuples, options, tup, _ref, _ref1;
    ...
    if (this._optionStringActions[arg_string] != null) {
      action = this._optionStringActions[arg_string];
    ...
    if (__indexOf.call(arg_string, '=') >= 0) {
      ...
      if (this._optionStringActions[option_string] != null) {
        action = this._optionStringActions[option_string];
    ...
    if (arg_string.match(this._regexpNegativeNumber)) {
      if (!_.any(this._has_negative_number_optionals)) {
        return null;
      }
    }
    if (__indexOf.call(arg_string, ' ') >= 0) {
  ...
  ArgumentParser.prototype._get_option_tuples = function(option_string) {
    var action, chars, explicit_arg, option_prefix, result, short_explicit_arg, short_option_prefix, tup, _ref, _ref1, _ref2, _ref3, _ref4;
    result = [];
  ...
  ArgumentParser.prototype._check_value = function(action, value) {
    var msg;
    if (action.choices === !null && __indexOf.call(action.choices, value) < 0) {
      msg = "invalid choice: " + value + " (choose from " + action.choices + ")";
      return this.error(action, msg);
    }
  };
  ...
  ArgumentParser.prototype.format_help = function() {
    var actionGroup, formatter, _i, _len, _ref;
    formatter = this._getFormatter();
    formatter.addUsage(this.usage, this._actions, []);
    formatter.addText(this.description);
    _ref = this._actionGroups;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      actionGroup = _ref[_i];
  ...
  ArgumentParser.prototype.parseKnownArgs = function(args) {
    return this.parse_known_args(args);
  };
...
TEST = !(module.parent != null) ? true : false;
