...
(function() {
  var $$, ActionContainer, ArgumentParser, DEBUG, FileClass, FileType, HelpFormatter, Namespace, Nsp, TEST, action, adir, args, argumentErrorHelper, argv, assert, c1, c2, childParser, getattr, hasattr, int1, parentParser, parser, path, setattr, subparsers, util, _, _ActionsContainer, _ensure_value, _get_action_name,
    __slice = [].slice,
  ...
  ArgumentParser = (function(_super) {
    ...
    ArgumentParser.prototype._parse_known_args = function(arg_strings, namespace) {
      var action, actionConflicts, actionHash, action_used, arg_string, arg_string_pattern, arg_string_pattern_parts, conflicts, consume_optional, consume_positionals, extras, group, group_actions, i, index, index_keys, key, max_option_string_index, msg, mutex_action, mutex_group, names, next_option_string_index, option_string_indices, option_tuple, pattern, positionals, positionals_end_index, seen_actions, seen_non_default_actions, start_index, stop_index, strings, take_action, x, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _ref, _ref1, _ref2, _ref3, _ref4,
        _this = this;
      ...
      _ref = this._mutuallyExclusiveGroups;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        mutex_group = _ref[_i];
      ...
      take_action = function(action, argument_strings, option_string) {
        var actionConflict, argument_values, msg, _len4, _m, _ref2;
        ...
        if (argument_values !== action.defaultValue) {
          ...
          if (actionConflicts[key] != null) {
            _ref2 = actionConflicts[key];
            for (_m = 0, _len4 = _ref2.length; _m < _len4; _m++) {
              actionConflict = _ref2[_m];
      ...
      consume_optional = function(start_index) {
        var action, action_tuples, arg_count, args, char, chars, explicit_arg, match_argument, msg, new_explicit_arg, option_string, optionals_map, selected_patterns, start, stop, _len4, _m, _ref2, _ref3;
        ...
        while (true) {
          ...
          if (explicit_arg != null) {
            ...
            if (arg_count === 0 && (_ref2 = option_string[1], __indexOf.call(chars, _ref2) < 0)) {
              DEBUG("explicit arg: '" + explicit_arg + "', '" + option_string + "'");
              action_tuples.push([action, [], option_string]);
              char = option_string[0];
              option_string = char + explicit_arg[0];
              new_explicit_arg = explicit_arg.slice(1) || null;
              optionals_map = _this._optionStringActions;
        ...
        for (_m = 0, _len4 = action_tuples.length; _m < _len4; _m++) {
          _ref3 = action_tuples[_m], action = _ref3[0], args = _ref3[1], option_string = _ref3[2];
      ...
      consume_positionals = function(start_index) {
        var action, arg_count, arg_counts, args, match_partial, selected_pattern, _len4, _m, _ref2, _ref3, _ref4;
        ...
        if (arg_counts.length) {
          _ref2 = _.zip(positionals, arg_counts);
          for (_m = 0, _len4 = _ref2.length; _m < _len4; _m++) {
            _ref3 = _ref2[_m], action = _ref3[0], arg_count = _ref3[1];
        ...
        [].splice.apply(positionals, [0, 9e9].concat(_ref4 = positionals.slice(arg_counts.length))), _ref4;
        return start_index;
      };
      extras = [];
      start_index = 0;
      index_keys = (function() {
        ...
        _ref2 = _.keys(option_string_indices);
        _results = [];
        for (_m = 0, _len4 = _ref2.length; _m < _len4; _m++) {
          x = _ref2[_m];
          _results.push(+x);
      ...
      action_used = false;
      _ref3 = this._mutuallyExclusiveGroups;
      for (_n = 0, _len5 = _ref3.length; _n < _len5; _n++) {
        group = _ref3[_n];
        if (group.required) {
          DEBUG('group required');
          _ref4 = group._groupActions;
          ...
          if (!action_used) {
            ...
            names = (function() {
              var _len7, _p, _ref5, _results;
              _ref5 = group._groupActions;
              _results = [];
    ...
    ArgumentParser.prototype._get_option_tuples = function(option_string) {
      ...
      if ((_ref = option_string[0], __indexOf.call(chars, _ref) >= 0) && (_ref1 = option_string[1], __indexOf.call(chars, _ref1) >= 0)) {
        ...
        for (option_string in this._optionStringActions) {
