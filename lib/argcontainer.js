...
(function() {
  var $$, ActionAppend, ActionAppendConstant, ActionCount, ActionHelp, ActionStore, ActionStoreConstant, ActionStoreFalse, ActionStoreTrue, ActionSubparsers, ActionVersion, ArgumentError, DEBUG, action, assert, container, path, util, _, _ActionsContainer, _ArgumentGroup, _MutuallyExclusiveGroup,
    __slice = [].slice,
  ...
  _ActionsContainer = (function() {
    ...
    _ActionsContainer.prototype._handle_conflict_resolve = function(action, conflicting_actions) {
      ...
      for (_i = 0, _len = conflicting_actions.length; _i < _len; _i++) {
        ...
        console.log(this._option_string_actions[option_string]);
  ...
  _ArgumentGroup = (function(_super) {
    ...
    _ArgumentGroup.prototype._remove_action = function(action) {
      ...
      return delete this._group_actions[action];
    };
