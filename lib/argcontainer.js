...
(function() {
  var $$, ActionAppend, ActionAppendConstant, ActionCount, ActionHelp, ActionStore, ActionStoreConstant, ActionStoreFalse, ActionStoreTrue, ActionSubparsers, ActionVersion, DEBUG, adir, assert, container, path, util, _, _ActionsContainer, _ArgumentGroup, _MutuallyExclusiveGroup,
    __slice = [].slice,
  ...
  _ActionsContainer = (function() {
    ...
    function _ActionsContainer(options) {
      ...
      this.prefix_chars = options.prefixChars;
    ...
    _ActionsContainer.prototype.add_argument = function() {
      var action, action_class, args, chars, dest, options, type_func, _i, _ref;
      ...
      if (!('defaultValue' in options)) {
        ...
        } else if (this.argumentDefault === !null) {
    ...
    _ActionsContainer.prototype._add_container_actions = function(container) {
      var action, actionHash, ctr, group, group_map, msg, mutex_group, required, title_group_map, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _results;
      title_group_map = {};
      DEBUG(this);
    ...
    _ActionsContainer.prototype._get_optional_options = function(args, options) {
      ...
      for (_i = 0, _len = args.length; _i < _len; _i++) {
        ...
        if (_ref = !option_string[0], __indexOf.call(this.prefix_chars, _ref) >= 0) {
          msg = "invalid option string " + option_string + ": '                        'must start with a character " + this.prefixChars;
          throw new Error(msg);
        }
    ...
    _ActionsContainer.prototype._get_handler = function() {
      ...
      return this.conflictHandler === 'error';
  ...
  _ArgumentGroup = (function(_super) {
    ...
    function _ArgumentGroup(container, options) {
      ...
      options.prefixChars = (_ref = options.prefixChars) != null ? _ref : container.prefixChars;
      options.argumentDefault = (_ref1 = options.argumentDefault) != null ? _ref1 : container.argumentDefault;
  ...
  _MutuallyExclusiveGroup = (function(_super) {
    ...
    function _MutuallyExclusiveGroup(container, options) {
      _MutuallyExclusiveGroup.__super__.constructor.call(this, options);
    ...
    _MutuallyExclusiveGroup.prototype._add_action = function(action) {
      ...
      action = _MutuallyExclusiveGroup.__super__._add_action.call(this, action);
      this._group_actions.push(action);
      return action;
    };

    _MutuallyExclusiveGroup.prototype._remove_action = function(action) {
      _MutuallyExclusiveGroup.__super__._remove_action.call(this, action);
      return this._group_actions.remove(action);
    };
