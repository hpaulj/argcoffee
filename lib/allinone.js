...
ArgumentParser = (function(_super) {
  ...
  ArgumentParser.prototype._parse_known_args = function(arg_strings, namespace) {
    ...
    consume_optional = function(start_index, no_action, penult) {
      var action_tuples, arg_count, args, chars, explicit_arg, match_argument, msg, new_explicit_arg, option_string, optionals_map, selected_patterns, shared_count, slots, start, stop, tuple, _len4, _m, _ref3;
      if (no_action == null) {
        no_action = false;
      }
      if (penult == null) {
  ...
  ArgumentParser.prototype._is_nargs_variable = function(action) {
    ...
    if (_.isArray(action)) {
      ...
      if ((_ref = action.nargs) === $$.OPTIONAL || _ref === $$.ZERO_OR_MORE || _ref === $$.ONE_OR_MORE || _ref === $$.REMAINDER || _ref === $$.PARSER) {
        return true;
      }
  ...
  ArgumentParser.prototype.parse_intermixed_args = function(args, namespace) {
    ...
    _ref = this.parse_known_intermixed_args(args, namespace), args = _ref[0], argv = _ref[1];
    if (argv.length > 0) {
      msg = "unrecognized arguments: " + (argv.join(' '));
      this.error(msg);
    }
  ...
  ArgumentParser.prototype.parse_known_intermixed_args = function(args, namespace, _fallback) {
    var a, err, extras, group, optionals, positionals, remaining_args, save_usage, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _ref, _ref1, _ref2;
    if (args == null) {
      args = null;
    }
    if (namespace == null) {
    ...
    a = (function() {
      var _i, _len, _ref, _results;
      _ref = this._mutually_exclusive_groups;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        group = _ref[_i];
        _results.push((function() {
          var _j, _len1, _ref1, _results1;
          _ref1 = group._group_actions;
          _results1 = [];
          for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
            action = _ref1[_j];
    ...
    try {
      ...
      try {
        _ref1 = this.parse_known_args(remaining_args, namespace), namespace = _ref1[0], extras = _ref1[1];
      } finally {
