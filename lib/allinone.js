...
_get_action_name = function(argument) {
  ...
  } else if ((_ref3 = argument.metavar) !== null && _ref3 !== $$.SUPPRESS) {
    return argument.metavar;
  } else if ((_ref4 = argument.dest) !== null && _ref4 !== $$.SUPPRESS) {
...
Action = (function() {
  ...
  */
  ...
  function Action(options) {
    ...
    this.option_strings = (_ref3 = options.option_strings) != null ? _ref3 : [];
    this.dest = (_ref4 = options.dest) != null ? _ref4 : '';
    this.nargs = (_ref5 = options.nargs) != null ? _ref5 : null;
    this.constant = (_ref6 = options.constant) != null ? _ref6 : null;
    this.defaultValue = (_ref7 = options.defaultValue) != null ? _ref7 : null;
    this.type = (_ref8 = options.type) != null ? _ref8 : null;
    this.choices = (_ref9 = options.choices) != null ? _ref9 : null;
    this.required = (_ref10 = options.required) != null ? _ref10 : false;
    this.help = (_ref11 = options.help) != null ? _ref11 : null;
    this.metavar = (_ref12 = options.metavar) != null ? _ref12 : null;
  }
  ...
  Action.prototype.getName = function() {
    ...
    } else if ((_ref3 = this.metavar) != null ? _ref3 : this.metavar !== $$.SUPPRESS) {
      return this.metavar;
    } else if ((_ref4 = this.dest) != null ? _ref4 : this.dest !== $$.SUPPRESS) {
      return this.dest;
    }
  };
...
_SubParsersAction = (function(_super) {
  ...
  function _SubParsersAction(options) {
    ...
    this._parser_class = (_ref3 = options.parser_class) != null ? _ref3 : options.parserClass;
    this._name_parser_map = {};
    this._choices_actions = [];
    options.dest = (_ref4 = options.dest) != null ? _ref4 : $$.SUPPRESS;
    options.nargs = $$.PARSER;
    options.choices = this._name_parser_map;
    options.required = (_ref5 = options.required) != null ? _ref5 : true;
  ...
  _SubParsersAction.prototype.__call__ = function(parser, namespace, values, option_string) {
    var arg_strings, astring, choices, msg, parser_name, _i, _len, _ref3, _ref4, _results;
    if (option_string == null) {
      option_string = null;
    }
    ...
    parser = (_ref3 = this._name_parser_map[parser_name]) != null ? _ref3 : null;
    if (parser === null) {
      choices = _.keys(this._name_parser_map).join(', ');
      msg = "unknown parser " + parser_name + " (choices: " + choices + ")";
      throw new ArgumentError(this, msg);
    }
    _ref4 = parser.parse_known_args(arg_strings, namespace), namespace = _ref4[0], arg_strings = _ref4[1];
...
fileType = function(options) {
  var createStream, flags, fn, fs, msg, std, _ref3, _ref4;
  if (options == null) {
    options = {
      flags: 'r'
    };
  ...
  if (flags === 'r') {
    _ref3 = [process.stdin, fs.createReadStream], std = _ref3[0], createStream = _ref3[1];
  } else if (flags === 'w') {
    _ref4 = [process.stdout, fs.createWriteStream], std = _ref4[0], createStream = _ref4[1];
  } else {
...
_ActionsContainer = (function() {
  function _ActionsContainer(options) {
    ...
    this.prefix_chars = (_ref3 = options.prefixChars) != null ? _ref3 : options.prefix_chars;
  ...
  _ActionsContainer.prototype._registry_get = function(registry_name, value, defaultValue) {
    ...
    return (_ref3 = this._registries[registry_name][value]) != null ? _ref3 : defaultValue;
  };
  ...
  _ActionsContainer.prototype.get_default = function(dest) {
    ...
    return (_ref4 = this._defaults[dest]) != null ? _ref4 : null;
  };
  ...
  _ActionsContainer.prototype.add_argument = function() {
    var action_class, args, chars, dest, options, type_func, _i, _ref3;
    ...
    if (args.length === 0 || (args.length === 1 && (_ref3 = args[0][0], __indexOf.call(chars, _ref3) < 0))) {
  ...
  _ActionsContainer.prototype._add_action = function(action) {
    var option_string, _i, _j, _len, _len1, _ref3, _ref4;
    this._check_conflict(action);
    this._actions.push(action);
    action.container = this;
    _ref3 = action.option_strings;
    for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
      option_string = _ref3[_i];
      this._option_string_actions[option_string] = action;
    }
    _ref4 = action.option_strings;
    for (_j = 0, _len1 = _ref4.length; _j < _len1; _j++) {
      option_string = _ref4[_j];
  ...
  _ActionsContainer.prototype._add_container_actions = function(container) {
    var actionHash, ctr, group, group_map, msg, mutex_group, title_group_map, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _results;
    title_group_map = {};
    _ref3 = this._action_groups;
    for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
      group = _ref3[_i];
    ...
    _ref4 = container._action_groups;
    for (_j = 0, _len1 = _ref4.length; _j < _len1; _j++) {
      group = _ref4[_j];
      if (!(group.title in title_group_map)) {
    ...
    _ref6 = container._mutually_exclusive_groups;
    for (_l = 0, _len3 = _ref6.length; _l < _len3; _l++) {
      group = _ref6[_l];
      mutex_group = this.add_mutually_exclusive_group({
        required: group.required
      });
      _ref7 = group._group_actions;
      for (_m = 0, _len4 = _ref7.length; _m < _len4; _m++) {
        action = _ref7[_m];
        group_map[actionHash(action)] = mutex_group;
      }
    }
    _ref8 = container._actions;
    _results = [];
    for (_n = 0, _len5 = _ref8.length; _n < _len5; _n++) {
      action = _ref8[_n];
      ctr = (_ref9 = group_map[action.getName()]) != null ? _ref9 : this;
  ...
  _ActionsContainer.prototype._get_positional_options = function(dest, options) {
    ...
    */
    ...
    if ((_ref3 = options.nargs) !== $$.OPTIONAL && _ref3 !== $$.ZERO_OR_MORE) {
      options.required = true;
  ...
  _ActionsContainer.prototype._check_conflict = function(action) {
    var confl_optional, confl_optionals, conflict_handler, option_string, _i, _len, _ref3;
    confl_optionals = [];
    _ref3 = action.option_strings;
    for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
      option_string = _ref3[_i];
  ...
  _ActionsContainer.prototype._handle_conflict_resolve = function(action, conflicting_actions) {
    var i, option_string, _i, _len, _ref3, _results;
    _results = [];
    for (_i = 0, _len = conflicting_actions.length; _i < _len; _i++) {
      _ref3 = conflicting_actions[_i], option_string = _ref3[0], action = _ref3[1];
...
_ArgumentGroup = (function(_super) {
  ...
  function _ArgumentGroup(container, options) {
    ...
    options.prefix_chars = (_ref3 = options.prefixChars) != null ? _ref3 : container.prefix_chars;
    options.argument_default = (_ref4 = options.argument_default) != null ? _ref4 : container.argument_default;
    options.conflict_handler = (_ref5 = options.conflict_handler) != null ? _ref5 : container.conflict_handler;
...
Namespace = (function() {
  ...
  Namespace.prototype.get = function(key, defaultValue) {
    var _ref3;
    return (_ref3 = this[key]) != null ? _ref3 : defaultValue;
  };
...
ArgumentParser = (function(_super) {
  ...
  function ArgumentParser(options) {
    var acoptions, defaultKey, default_prefix, parent, _i, _len, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref20, _ref21, _ref22, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    if (options == null) {
      options = {};
    }
    ...
    this.prog = (_ref3 = options.prog) != null ? _ref3 : path.basename(process.argv[1]);
    this.usage = (_ref4 = options.usage) != null ? _ref4 : null;
    this.epilog = (_ref5 = options.epilog) != null ? _ref5 : null;
    this.parents = (_ref6 = options.parents) != null ? _ref6 : [];
    this.formatter_class = (_ref7 = (_ref8 = options.formatter_class) != null ? _ref8 : options.formatterClass) != null ? _ref7 : HelpFormatter;
    this.fromfile_prefix_chars = (_ref9 = (_ref10 = options.fromfile_prefix_chars) != null ? _ref10 : options.fromfilePrefixChars) != null ? _ref9 : null;
    this.add_help = (_ref11 = (_ref12 = options.addHelp) != null ? _ref12 : options.add_help) != null ? _ref11 : true;
    this.debug = (_ref13 = options.debug) != null ? _ref13 : false;
    this.description = (_ref14 = options.description) != null ? _ref14 : null;
    this.prefix_chars = (_ref15 = (_ref16 = options.prefixChars) != null ? _ref16 : options.prefix_chars) != null ? _ref15 : '-';
    this.argument_default = (_ref17 = (_ref18 = options.argumentDefault) != null ? _ref18 : options.argument_default) != null ? _ref17 : null;
    this.conflict_handler = (_ref19 = (_ref20 = options.conflict_handler) != null ? _ref20 : options.conflictHandler) != null ? _ref19 : 'error';
    this.args_default_to_positional = (_ref21 = options.args_default_to_positional) != null ? _ref21 : false;
    acoptions = {
  ...
  ArgumentParser.prototype.add_subparsers = function(options) {
    var ParsersClass, description, formatter, groups, positionals, title, _ref3, _ref4, _ref5;
    if (options == null) {
      options = {};
    }
    ...
    if ((options.title != null) || (options.description != null)) {
      title = (_ref3 = options.title) != null ? _ref3 : 'subcommands';
    ...
    if (options.prog == null) {
      ...
      groups = (_ref5 = this._mutuallyExclusiveGroups) != null ? _ref5 : this._mutually_exclusive_groups;
  ...
  ArgumentParser.prototype.parse_args = function(args, namespace) {
    ...
    _ref3 = this.parse_known_args(args, namespace), args = _ref3[0], argv = _ref3[1];
    if (argv.length > 0) {
  ...
  ArgumentParser.prototype.parse_known_args = function(args, namespace) {
    var argv, dest, error, _default, _i, _len, _ref3, _ref4;
    if (args == null) {
      args = null;
    }
    if (namespace == null) {
    ...
    try {
      _ref4 = this._parse_known_args(args, namespace), namespace = _ref4[0], args = _ref4[1];
  ...
  ArgumentParser.prototype._parse_known_args = function(arg_strings, namespace) {
    ...
    mxgroups = (_ref3 = this._mutuallyExclusiveGroups) != null ? _ref3 : this._mutually_exclusive_groups;
    for (_i = 0, _len = mxgroups.length; _i < _len; _i++) {
      mutex_group = mxgroups[_i];
      group_actions = (_ref4 = mutex_group._groupActions) != null ? _ref4 : mutex_group._group_actions;
    ...
    take_action = function(action, argument_strings, option_string) {
      var actionConflict, argument_values, msg, _len4, _m, _ref6;
      if (option_string == null) {
        option_string = null;
      }
      ...
      if (argument_values !== action.defaultValue) {
        ...
        if (actionConflicts[key] != null) {
          _ref6 = actionConflicts[key];
          for (_m = 0, _len4 = _ref6.length; _m < _len4; _m++) {
            actionConflict = _ref6[_m];
    ...
    consume_optional = function(start_index, no_action, penult) {
      var action_tuples, arg_count, args, chars, explicit_arg, match_argument, msg, new_explicit_arg, option_string, optionals_map, selected_patterns, shared_count, slots, start, stop, tuple, _len4, _m, _ref6;
      if (no_action == null) {
        no_action = false;
      }
      if (penult == null) {
      ...
      while (true) {
        ...
        if (explicit_arg != null) {
          ...
          if (arg_count === 0 && (_ref6 = option_string[1], __indexOf.call(chars, _ref6) < 0)) {
    ...
    consume_positionals = function(start_index, no_action) {
      var arg_count, arg_counts, args, ii, match_partial, pats, selected_pattern, _len4, _m, _ref10, _ref6, _ref7, _ref8, _ref9;
      if (no_action == null) {
        no_action = false;
      }
      ...
      _ref6 = _.zipShortest(positionals, arg_counts);
      for (_m = 0, _len4 = _ref6.length; _m < _len4; _m++) {
        _ref7 = _ref6[_m], action = _ref7[0], arg_count = _ref7[1];
        args = arg_strings.slice(start_index, start_index + arg_count);
        if ((_ref8 = action.nargs) !== $$.PARSER && _ref8 !== $$.REMAINDER) {
          pats = arg_string_pattern.slice(start_index, start_index + arg_count);
          DEBUG('take action:', action.dest, args, pats);
          ii = pats.indexOf('-');
          if (ii > -1) {
            assert(args[ii] === '--');
            [].splice.apply(args, [ii, ii - ii + 1].concat(_ref9 = [])), _ref9;
      ...
      [].splice.apply(positionals, [0, 9e9].concat(_ref10 = positionals.slice(arg_counts.length))), _ref10;
      return start_index;
    };
    consume_loop = function(no_action, penult) {
      ...
      index_keys = (function() {
        ...
        _ref6 = _.keys(option_string_indices);
        _results = [];
        for (_m = 0, _len4 = _ref6.length; _m < _len4; _m++) {
          x = _ref6[_m];
          _results.push(+x);
    ...
    action_used = false;
    _ref8 = (_ref7 = this._mutuallyExclusiveGroups) != null ? _ref7 : this._mutually_exclusive_groups;
    for (_o = 0, _len5 = _ref8.length; _o < _len5; _o++) {
      group = _ref8[_o];
      if (group.required) {
        gactions = (_ref9 = group._groupActions) != null ? _ref9 : group._group_actions;
  ...
  ArgumentParser.prototype._read_args_from_files = function(arg_strings) {
    var arg, arg_line, arg_string, argstrs, content, error, filename, firstchar, fs, new_arg_strings, _i, _j, _k, _len, _len1, _len2, _ref3;
    fs = require('fs');
    new_arg_strings = [];
    for (_i = 0, _len = arg_strings.length; _i < _len; _i++) {
      ...
      if (__indexOf.call(this.fromfile_prefix_chars, firstchar) < 0) {
        ...
        try {
          ...
          for (_j = 0, _len1 = content.length; _j < _len1; _j++) {
            arg_line = content[_j];
            _ref3 = this.convert_arg_line_to_args(arg_line);
  ...
  ArgumentParser.prototype._match_argument = function(action, arg_strings_pattern) {
    var args_errors, matches, msg, nargs_pattern, _ref3;
    ...
    if (matches == null) {
      ...
      msg = (_ref3 = args_errors[action.nargs]) != null ? _ref3 : "expected " + action.nargs + " argument(s)";
      throw new ArgumentError(action, msg);
    }
  ...
  ArgumentParser.prototype._match_arguments_partial = function(actions, arg_strings_pattern) {
    var actions_slice, foo, i, m, pattern, result, strlength, _i, _ref3;
    result = [];
    foo = this._get_nargs_pattern;
    strlength = function(string) {
      return string.length;
    };
    for (i = _i = _ref3 = actions.length; _ref3 <= 0 ? _i <= 0 : _i >= 0; i = _ref3 <= 0 ? ++_i : --_i) {
  ...
  ArgumentParser.prototype._parse_optional = function(arg_string) {
    var actions, explicit_arg, option_string, option_tuple, option_tuples, options, tup, _ref3, _ref4;
    assert(this.prefix_chars != null);
    if (!arg_string) {
      return null;
    }
    if (!(_ref3 = arg_string[0], __indexOf.call(this.prefix_chars, _ref3) >= 0)) {
      return null;
    }
    ...
    if (__indexOf.call(arg_string, '=') >= 0) {
      _ref4 = arg_string.split('='), option_string = _ref4[0], explicit_arg = _ref4[1];
    ...
    if (option_tuples.length > 1) {
      options = (function() {
        ...
        for (_i = 0, _len = option_tuples.length; _i < _len; _i++) {
          _ref5 = option_tuples[_i], action = _ref5[0], option_string = _ref5[1], explicit_arg = _ref5[2];
  ...
  ArgumentParser.prototype._get_option_tuples = function(option_string) {
    var actions, chars, explicit_arg, option_prefix, result, short_explicit_arg, short_option_prefix, tup, _ref3, _ref4, _ref5, _ref6, _ref7;
    result = [];
    chars = this.prefix_chars;
    if ((_ref3 = option_string[0], __indexOf.call(chars, _ref3) >= 0) && (_ref4 = option_string[1], __indexOf.call(chars, _ref4) >= 0)) {
      if (__indexOf.call(option_string, '=') >= 0) {
        _ref5 = option_string.split('='), option_prefix = _ref5[0], explicit_arg = _ref5[1];
      } else {
    ...
    } else if ((_ref6 = option_string[0], __indexOf.call(chars, _ref6) >= 0) && (_ref7 = option_string[1], __indexOf.call(chars, _ref7) < 0)) {
      option_prefix = option_string;
      explicit_arg = null;
  ...
  ArgumentParser.prototype._is_nargs_variable = function(action) {
    ...
    if (_.isArray(action)) {
      ...
      if ((_ref3 = action.nargs) === $$.OPTIONAL || _ref3 === $$.ZERO_OR_MORE || _ref3 === $$.ONE_OR_MORE || _ref3 === $$.REMAINDER || _ref3 === $$.PARSER) {
        return true;
      }
  ...
  ArgumentParser.prototype.parse_intermixed_args = function(args, namespace) {
    ...
    _ref3 = this.parse_known_intermixed_args(args, namespace), args = _ref3[0], argv = _ref3[1];
    if (argv.length > 0) {
      msg = "unrecognized arguments: " + (argv.join(' '));
      this.error(msg);
    }
  ...
  ArgumentParser.prototype.parse_known_intermixed_args = function(args, namespace) {
    var a, extras, group, optionals, positionals, remaining_args, save_usage, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _ref3, _ref4, _ref5;
    if (args == null) {
      args = null;
    }
    if (namespace == null) {
    ...
    a = (function() {
      ...
      for (_i = 0, _len = positionals.length; _i < _len; _i++) {
        ...
        if ((_ref3 = action.nargs) === $$.PARSER || _ref3 === $$.REMAINDER) {
          _results.push(action);
        }
      }
      return _results;
    ...
    try {
      ...
      try {
        _ref4 = this.parse_known_args(remaining_args, namespace), namespace = _ref4[0], extras = _ref4[1];
      } finally {
        for (_n = 0, _len5 = optionals.length; _n < _len5; _n++) {
          action = optionals[_n];
          action.required = action.save_required;
        }
        _ref5 = this._mutually_exclusive_groups;
  ...
  ArgumentParser.prototype._get_values = function(action, arg_strings) {
    var arg_string, avalue, ii, s, v, value, _i, _j, _len, _len1, _ref3, _ref4;
    if ((_ref3 = action.nargs) !== $$.PARSER && _ref3 !== $$.REMAINDER) {
      switch ('none') {
        case 'all':
          arg_strings = (function() {
    ...
    } else if (arg_strings.length === 1 && ((_ref4 = action.nargs) === null || _ref4 === $$.OPTIONAL)) {
  ...
  ArgumentParser.prototype.format_help = function() {
    var actionGroup, formatter, _i, _len, _ref3, _ref4, _ref5;
    formatter = this._get_formatter();
    formatter.addUsage(this.usage, this._actions, this._mutually_exclusive_groups);
    formatter.addText(this.description);
    _ref4 = (_ref3 = this._actionGroups) != null ? _ref3 : this._action_groups;
    for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
      actionGroup = _ref4[_i];
      formatter.startSection(actionGroup.title);
      formatter.addText(actionGroup.description);
      formatter.addArguments((_ref5 = actionGroup._groupActions) != null ? _ref5 : actionGroup._group_actions);
    ...
    if (1) {
      ...
      if (1) {
        ...
        console.log('child optional actions: ', (function() {
          var _i, _len, _ref3, _results;
          _ref3 = childParser._optionals._group_actions;
          _results = [];
          for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
            action = _ref3[_i];
        ...
        console.log('child positional actions: ', (function() {
          var _i, _len, _ref3, _results;
          _ref3 = childParser._positionals._group_actions;
          _results = [];
          for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
            action = _ref3[_i];
            _results.push(action.dest);
