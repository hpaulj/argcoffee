...
HelpFormatter = (function() {
  ...
  */
  ...
  HelpFormatter.prototype._metavar_formatter = function(action, default_metavar) {
    ...
    format = function(tuple_size) {
      if (_.isArray(result)) {
        ...
        return _.times(tuple_size, function() {
          return result;
        });
      }
    };
  ...
  HelpFormatter.prototype._format_args = function(action, default_metavar) {
    var formats, get_metavar, result;
...
_ActionsContainer = (function() {
  ...
  _ActionsContainer.prototype._get_handler = function() {
    ...
    if (func != null) {
      ...
      msg = "invalid conflict resolution value: " + this.conflictHandler;
      throw new Error(msg);
    }
  };
...
ArgumentParser = (function(_super) {
  ...
  function ArgumentParser(options) {
    var acoptions, defaultKey, default_prefix, parent, _i, _len, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if (options == null) {
      options = {};
    }
  ...
  ArgumentParser.prototype._parse_known_args = function(arg_strings, namespace) {
    ...
    for (i = _k = 0, _len2 = arg_strings.length; _k < _len2; i = ++_k) {
      ...
      if (arg_string === '--') {
        if (true) {
          ...
          [].splice.apply(arg_strings, [i, i - i + 1].concat(_ref4 = [])), _ref4;
          break;
        }
      } else {
    ...
    assert(((function() {
      ...
      _results = [];
      for (_n = 0, _len5 = arg_string_pattern.length; _n < _len5; _n++) {
        x = arg_string_pattern[_n];
        if (x === '-') {
          _results.push(x);
        }
      }
    ...
    take_action = function(action, argument_strings, option_string) {
      var actionConflict, argument_values, msg, _len5, _n, _ref5;
      if (option_string == null) {
        option_string = null;
      }
      ...
      if (argument_values !== action.defaultValue) {
        ...
        if (actionConflicts[key] != null) {
          _ref5 = actionConflicts[key];
          for (_n = 0, _len5 = _ref5.length; _n < _len5; _n++) {
            actionConflict = _ref5[_n];
    ...
    consume_optional = function(start_index) {
      var action_tuples, arg_count, args, chars, explicit_arg, match_argument, msg, new_explicit_arg, option_string, optionals_map, selected_patterns, start, stop, tuple, _len5, _n, _ref5;
      ...
      while (true) {
        ...
        if (explicit_arg != null) {
          ...
          if (arg_count === 0 && (_ref5 = option_string[1], __indexOf.call(chars, _ref5) < 0)) {
      ...
      for (_n = 0, _len5 = action_tuples.length; _n < _len5; _n++) {
        tuple = action_tuples[_n];
    ...
    consume_positionals = function(start_index) {
      var arg_count, arg_counts, args, ii, match_partial, pats, selected_pattern, _len5, _n, _ref5, _ref6, _ref7, _ref8;
      ...
      _ref5 = _.zipShortest(positionals, arg_counts);
      for (_n = 0, _len5 = _ref5.length; _n < _len5; _n++) {
        _ref6 = _ref5[_n], action = _ref6[0], arg_count = _ref6[1];
        ...
        if (ii > -1) {
          assert(args[ii] === '--');
          [].splice.apply(args, [ii, ii - ii + 1].concat(_ref7 = [])), _ref7;
          DEBUG('take action:', action.dest, args);
        }
        take_action(action, args);
      }
      [].splice.apply(positionals, [0, 9e9].concat(_ref8 = positionals.slice(arg_counts.length))), _ref8;
      return start_index;
    };
    extras = [];
    start_index = 0;
    index_keys = (function() {
      ...
      _ref5 = _.keys(option_string_indices);
      _results = [];
      for (_n = 0, _len5 = _ref5.length; _n < _len5; _n++) {
        x = _ref5[_n];
        _results.push(+x);
    ...
    foo = function(start_index) {
      var index, _len5, _n, _results;
      _results = [];
      for (_n = 0, _len5 = index_keys.length; _n < _len5; _n++) {
        index = index_keys[_n];
    ...
    action_used = false;
    _ref7 = (_ref6 = this._mutuallyExclusiveGroups) != null ? _ref6 : this._mutually_exclusive_groups;
    for (_o = 0, _len6 = _ref7.length; _o < _len6; _o++) {
      group = _ref7[_o];
      if (group.required) {
        gactions = (_ref8 = group._groupActions) != null ? _ref8 : group._group_actions;
        ...
        if (!action_used) {
          names = (function() {
            ...
            _results = [];
            for (_q = 0, _len8 = gactions.length; _q < _len8; _q++) {
              action = gactions[_q];
              if (action.help !== $$.SUPPRESS) {
...
if (TEST) {
  (function() {
    var Nsp, args, c1, c2, childParser, parentParser, parser, subparsers, testparse;
